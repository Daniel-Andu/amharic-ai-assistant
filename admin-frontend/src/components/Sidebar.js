...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { path: '/conversations', icon: MessageSquare, label: 'Conversation Logs' },
        { path: '/top-questions', icon: HelpCircle, label: 'Top Questions' },
        { path: '/knowledge-base', icon: BookOpen, label: 'Knowledge Base' },
        { path: '/ai-training', icon: Brain, label: 'AI Training' },
        { path: '/user-stats', icon: BarChart3, label: 'User Stats' },
